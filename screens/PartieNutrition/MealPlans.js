  ...
  return (
    <View style={{ padding: 20 }}>
      ...
      <Card style={{ marginBottom: 20, padding: 15 }}>
        ...
        <ProgressBar progress={consumedMacros.calories / totalMacros.calories} color="skyblue" />

        <Text>Protein: {consumedMacros.protein}g/{totalMacros.protein}g</Text>
        <ProgressBar progress={consumedMacros.protein / totalMacros.protein} color="lightgreen" />

        <Text>Carbs: {consumedMacros.carbs}g/{totalMacros.carbs}g</Text>
        <ProgressBar progress={consumedMacros.carbs / totalMacros.carbs} color="tan" />

        <Text>Fats: {consumedMacros.fats}g/{totalMacros.fats}g</Text>
        <ProgressBar progress={consumedMacros.fats / totalMacros.fats} color="red" />
      </Card>
